...
export DOCKER_HUB='xinfinorg/xinfin-dev-net' # TODO: replace with XINFIN docker hub
export DOCKER_TAG=$1
...
export $(xargs < .env)
docker-compose -f devnet/docker-compose.yml config && docker-compose -f devnet/docker-compose.yml up -d
